...
public class evaluationDto {
	...
	public void setE_memid(String e_memid) {
		this.e_memid = e_memid;
	}
	...
	public String getE_document() {
		return e_document;
	}
	public void setE_document(String e_document) {
		this.e_document = e_document;
	}
	...
	public int getE_doccount() {
		return e_doccount;
	}
	public void setE_doccount(int e_doccount) {
		this.e_doccount = e_doccount;
	}
	public int getNo() {
		return no;
	}
